...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailRegister = (EditText) findViewById(R.id.emailregister);
        mPasswordRegister = (EditText) findViewById(R.id.passwordcreate);
        mPasswordConfirmRegister = (EditText) findViewById(R.id.passwordcreateconfirm);
